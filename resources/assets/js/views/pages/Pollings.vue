        ...
        <div class="row page-titles">
            <div class="col-md-12 col-8 align-self-center">
                ...
                <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item active">Pollings</li>
                </ol>
            </div>
        </div>
            ...
            <div class="col-lg-12">
                <div class="mb-4 card">
                    <div class="card-body">
                        ...
                        <md-table v-model="searched" md-sort="polling_name" md-sort-order="asc" md-card md-fixed-header>
                            <md-table-toolbar>
                            ...
                            <md-table-empty-state
                                md-label="No pollings found"
                                :md-description="`No polling found for this '${search}' query. Try a different search term.`">
                            ...
                            <md-table-row slot="md-table-row" slot-scope="{ item }">
                                ...
                                <md-table-cell md-label="Polling station" md-sort-by="polling_name">
                                    ...
                                    <div class="d-flex flex-column justify-content-center">
                                        <h6 class="mb-0 text-sm">{{item.polling_name}}</h6>
                                        <p class="text-xs text-secondary mb-0">{{ item.ward_name }}</p>
                                    </div>
                                    </div>
                                </md-table-cell>
                               ...
                               <md-table-cell md-label="Longitude" md-sort-by="longitude">{{ item.longitude }}</md-table-cell>
...
<script>
    ...
    const searchByFilter = (items, term) => {
        ...
        return items.filter(
            ...
            || toLower(item.polling_name).includes(toLower(term)) 
    ...
    export default {
        ...
        methods: {
            ...
            searchOnTable () {
                this.searched = searchByFilter(this.pollings, this.search)
            },
        },
        filters: {
        }
