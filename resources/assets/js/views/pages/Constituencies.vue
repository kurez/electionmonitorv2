            ...
            <div class="col-lg-12">
                <div class="mb-4 card">
                    <div class="card-body">
                        ...
                        <md-table v-model="searched" md-sort="constituency_name" md-sort-order="asc" md-card md-fixed-header>
                            <md-table-toolbar>
                            ...
                            <md-table-empty-state
                                md-label="No constituencies found"
                                :md-description="`No constituency found for this '${search}' query. Try a different search term.`">
                            ...
                            <md-table-row slot="md-table-row" slot-scope="{ item }">
                                ...
                                <!-- <md-table-cell md-label="Electoral position" md-sort-by="electoral_position">{{ item.electoral_position }}</md-table-cell> -->
                                 ...
                                 <md-table-cell md-label="Code" md-sort-by="const_code">{{ item.const_code }}</md-table-cell>
...
<script>
    ...
    const searchByFilter = (items, term) => {
        ...
        return items.filter(
            ...
            item => toLower(item.county_name).includes(toLower(term)) ||  toLower(item.constituency_name).includes(toLower(term))
    ...
    export default {
        ...
        methods: {
            ...
            searchOnTable () {
                this.searched = searchByFilter(this.constituencies, this.search)
            },
        },
        filters: {
        }
